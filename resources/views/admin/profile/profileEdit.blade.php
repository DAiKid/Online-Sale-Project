...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 col">
        ...
        <form action="{{ route('profileEdit#update') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-3">

                        <img class="img-profile img-thumbnail" id="output"  src="{{ Auth::user()->profile == null ? asset('default/defult-Image.png') : asset('profilePhoto/' . Auth::user()->profile) }}">

                        <input type="file" name="image" id="" class="form-control mt-1" accept="image/*" onchange="loadPhoto(event)">
