                    ...
                    <tbody>
                        ...
                        @foreach ($categories as $item)
                            ...
                            <tr class='my-2'>
                                ...
                                <td>
                                    <a href="{{route('category#edit',$item->id)}}" class="btn btn-sm btn-outline-secondary"> <i class="fa-solid fa-pen-to-square"></i> </a>

                                    <button type='button' onclick="deleteProcess( {{$item->id}} )" class="btn btn-sm btn-outline-danger" type="button"> <i class="fa-solid fa-trash"></i>
                                    </button>
                                </td>
                            </tr>
